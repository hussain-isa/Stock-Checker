...
suite('Functional Tests', function () {
    suite("5 functional get request tests", function () {
        ...
        test("Viewing multiple stocks: GET request to /api/stock-prices/", function (done) {
            chai
                .request(server)
                .get("/api/stock-prices/")
                .set("content-type", "application/json")
        ...
        test("Viewing multiple stocks and liking them: GET request to /api/stock-prices/", function (done) {
            chai
                .request(server)
                .get("/api/stock-prices/")
                .set("content-type", "application/json")
